    ...
    return (
        <div className="min-h-screen bg-gray-900">
            ...
            <header className="bg-gray-900/80 backdrop-blur-xl border-b border-gray-700/50">
                <div className="max-w-7xl mx-auto px-3 py-5 flex flex-col gap-y-4 items-center justify-between">
            ...
            <div className="max-w-7xl mx-auto px-3 py-8">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl border border-gray-700/50 py-6 px-3">
                            <h3 className="font-semibold text-white space-y-4 text-lg">
                                Мои списки
                            </h3>
                            <div className="flex gap-3 space-y-4 flex-row items-stretch">
                                <input
                                    type="file"
                                    accept=".json"
                                ...
                                <label
                                    htmlFor="import-file"
                                    className="flex px-4 max-h-full bg-gray-800 text-gray-300 rounded-xl hover:bg-gray-700 cursor-pointer transition-all text-base border border-gray-700 hover:border-gray-600 items-center"
                                >
                                    📥 Импорт
                                </label>
                                <button
                                    onClick={() => setShowNewListModal(true)}
                                    className="px-5 py-2 flex items-center text-2xl bg-white text-gray-900 rounded-xl hover:bg-gray-100 transition-all shadow-lg hover:shadow-xl font-medium"
                                >
                                    <span>
                                        <svg
                                    ...
                                    <span className="text-sm flex">Новый</span>
                                </button>
                            </div>
                    ...
                    <div className="lg:col-span-3">
                        {currentList ? (
                            <div className="space-y-8">
                                ...
                                <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl border border-gray-700/50 py-8 px-3">
                                    <div className="flex items-center flex-col gap-y-4 justify-between mb-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        <div className="bg-blue-600/20 py-6 px-3 rounded-2xl border border-blue-600/30">
                                        ...
                                        <div className="bg-green-600/20 py-6 px-3 rounded-2xl border border-green-600/30">
                                        ...
                                        <div className="bg-orange-600/20 py-6 px-3 rounded-2xl border border-orange-600/30">
                                ...
                                {currentList.items.length > 0 && (
                                    <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl border border-gray-700/50 py-8 px-3">
                                        ...
                                        <div className="mt-6 pt-6 border-t border-gray-700/50">
                                            <div className="flex flex-col gap-y-4 justify-between items-center text-sm">
                      ...
                      (Нажмите на товар для редактирования)
                                ...
                                {/* Список товаров */}
                                <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl border border-gray-700/50 py-8 px-3">
                                    <div className="flex flex-col gap-y-4 items-center justify-between mb-6">
            ...
            {showNewListModal && (
                <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50">
                    <div className="bg-gray-800 rounded-2xl py-8 px-3 w-full max-w-md mx-4 border border-gray-700/50">
